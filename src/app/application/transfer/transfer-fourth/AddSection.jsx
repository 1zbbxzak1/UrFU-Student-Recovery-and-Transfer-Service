...
const AddApplication = () => {
  ...
  return (
    <section className="mt-[40px] mb-[130px] mx-[80px]">
      <Link href="/transfer/transfer-fourth">
      ...
      <CreateApplication>
        <SelectDirection
          header={
            "Форма заявки на перевод на другое направление в другой институт с бюджетной формы обучения на бюджетную"
          }
          academicGroup={
