...
const AddApplication = () => {
  ...
  return (
    <section className="mt-[40px] mb-[130px] mx-[80px]">
      <Link href="/transfer/transfer-second">
      ...
      <CreateApplication>
        <SelectDirection
          header={
            "Форма заявки на перевод на другое направление внутри института с бюджетной формы обучения на бюджетную"
          }
          academicGroup={
