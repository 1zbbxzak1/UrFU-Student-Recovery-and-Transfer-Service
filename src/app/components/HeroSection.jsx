      ...
      <div className="w-[1427px] h-[550px] top-[100px] absolute bg-[#748AB9] rounded-bl-[70px] rounded-br-[70px]" />
        <div className="col-span-8 place-self-center text-center sm:text-left justify-self-start">
          ...
          <p className="text-white absolute sm:text-lg ml-14 mt-9 mb-8 lg:text-xl font-light text-2xl">
            Упростите процесс восстановления и перевода студентов УрФУ <br />
            с нашим удобным онлайн-сервисом. Получайте актуальную <br />
            информацию, подавайте документы, и решайте все вопросы в одном месте.
          </p>
        </div>
      </div>
    </section>
